...
Los motores pueden ser observados en la Fig. \ref{fig:mono_inside} del monocromador HR60 son los siguientes:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/chap2/monocromador-inside.jpg}
        \caption{Fotografía del monocromador mostrando la rejilla de difracción, el motor principal y las slits}
    \label{fig:mono_inside}
\end{figure}


\section{Diseño del programa de control}
\label{sec:ch2-control}
Para diseñar el programa de control del monocromador con base en Arduino, se tomó el programa de control en el \textit{Laboratorio de Elipsometría Espectroscópica, I.I.C.O., U.A.S.L.P} como apoyo. En este se definen algunas secuencias de control para el movimiento del monocromador, esperando una notificación de estado, además del guardado de la posición final del motor principal del sistema y de cada una de sus slits. Entonces para poder realizar la comunicación PC-Monocromador necesitamos lo siguiente:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.4\textwidth, angle=270]{figures/chap2/monocromador.pdf}
